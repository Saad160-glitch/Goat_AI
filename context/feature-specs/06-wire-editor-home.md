...
Fetch owned and shared projects server-side using the existing project data helper and ass both lists to the sidebar.

No client-side fetching for initial load.

### 'Use Project Actions'

Create a hook in 'hooks/' that dialog state and project mutations.
...
- delete dialog showd project name